#Import what you need from tkinter
...
class Contacts:
    ...
    def create_label_frame(self):
        ...
        Button(labelframe, text="Add contact", command=self.on_add_new_contact_button_clicked, bg="blue", fg="white").grid(row=4, column=2, sticky=E, padx=5, pady=5)
    ...
    def on_add_new_contact_button_clicked(self):
    ...
    def on_delete_selected_button_clicked(self):
        ...
        try:
            ...
            self.message["text"] = "No items selected to delete"
            return
    ...
    def on_modify_selected_button_clicked(self):
        ...
        try:
            ...
            self.message["text"] = "No items selected to modify"
            return
    ...
    def add_new_contacts(self):
        if self.new_contacts_validated():
            ...
            self.message["text"] = "name, email and number cannot be empty"
            self.view_contacts()
